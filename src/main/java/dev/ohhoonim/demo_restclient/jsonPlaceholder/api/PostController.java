...
import dev.ohhoonim.demo_restclient.jsonPlaceholder.internal.PostService;
...
public class PostController {
    ...
    @GetMapping("")
    public List<Post> searchFilterPosts(@RequestParam(value="title", required = false) String title, 
